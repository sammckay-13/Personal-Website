...
export default function BrownHeader() {
  return (
    <div className="flex flex-col flex-1 h-140 bg-[#FFFBEE] dark:bg-[#49362D] w-80%">
      <div className="flex flex-row bg-[#FFFBEE] dark:bg-[#49362D] md:ml-auto ml-21 mt-8 mr-10">
        <div className="flex w-20 md:w-30 mb-2 h-20">
          <MckaypableLogoAnimated />
        </div>
        <h1 className="text-3xl font-bold text-[#49362D] dark:text-[#FFFBEE] flex-row -ml-5 md:-ml-9 mb-9 flex items-center">
          Mckaypable
        </h1>
      </div>
      <div>
        <main className="flex flex-row ml-25 md:ml-15 items-center mb-15 bg-[#FFFBEE] dark:bg-[#49362D]">
        ...
        <div className="-mt-10 ml-15 text-[#49362D] dark:text-[#FFFBEE]">
